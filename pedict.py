...
det_weight = "C:/Users/dinhd/Desktop/OCR//weights/PANNet_best_map.pth"
ocr_weight = "C:/Users/dinhd/Desktop/OCR//weights/transformerocr.pth"

img = cv2.imread(f"C:/Users/dinhd/Desktop/OCR//test.jpg")
...
boxes, img2  = det_model(
    ...
    output_path=f"C:/Users/dinhd/Desktop/OCR//results/{img_id}"   #Path to save cropped regions
)

plt.imshow(img2)
plt.show()

img_paths = os.listdir(f"C:/Users/dinhd/Desktop/OCR//results/{img_id}/crops")  # Cropped regions
img_paths.sort(key=natural_keys)
img_paths = [os.path.join(f"C:/Users/dinhd/Desktop/OCR//results/{img_id}/crops", i) for i in img_paths]
import csv
import re
